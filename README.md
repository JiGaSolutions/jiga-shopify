...
A custom element for the YOOtheme Pro Page Builder to insert Shopify Item.
...
Please report issues using the [Github issue tool](https://github.com/JiGaSolutions/jiga-shopify/issues).
